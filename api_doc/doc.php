...
date_default_timezone_set('Asia/Shanghai');
    ...
    $methodStr = '//请使用@method添加方法说明';
    $author = '//请使用@author添加作者';
    if (!empty($docCommentArr)) {
        foreach ($docCommentArr as $comment) {
            ...
            if ($pos !== false) {
	          ...
	          if ($pos !== false) {
              $methodStr = substr($comment, $pos + 7);
	            continue;
	          }
...
<div class="ui text container" style="max-width: none !important; margin-top: 50px;">
    <div class="ui floating message">
	    ...
	    <div class="ui raised segment">
		    <span class="ui red ribbon label">接口作者</span>
		    <div class="ui message">
			    <p> <?php echo ($author ? $author : '//请使用@author添加作者');?></p>
		    </div>
	    </div>
		    <div class="ui raised segment">
		    <span class="ui red ribbon label">method说明</span>
		    <div class="ui message">
			    <p> <?php echo ($methodStr ? $methodStr : '//请使用@method添加方法说明');?></p>
		    </div>
	    </div>
        <div class="ui raised segment">

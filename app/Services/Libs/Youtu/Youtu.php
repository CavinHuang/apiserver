...
namespace App\Services\Libs\Youtu;
...
class YouTu
{
	...
	* @return 返回的结果，JSON字符串，字段参见API文档
     ...
     * @return 返回的结果，JSON字符串，字段参见API文档
     */
    public static function idcardocr($image_data, $card_type = 0, $seq = '') {
       ...
       /* if (!file_exists($real_image_path))
        ...
        $post_data = array(
            'app_id' =>  Conf::$APPID,
            'image' => $image_data, // base64_encode($image_data),
            'seq' => $seq,
    ...
    public static function idcardocrurl($url,  $card_type, $seq = '') {
        ...
        $req = array(
            ...
            'method' => 'post',
            'timeout' => 10,
            'data' => fuckTheWeChatInvalidJSON(json_encode($post_data)),
            'header' => array(
                'Authorization:'.$sign,
                'Content-Type:text/json',
                'Expect: ',
     ...
     * @return 返回的结果，JSON字符串，字段参见API文档
     */
    public static function namecardocr($image_data, $retimage = 1, $seq = '') {
     ...
     * @return 返回的结果，JSON字符串，字段参见API文档
     */
    public static function bcocr($image_data, $seq='') {

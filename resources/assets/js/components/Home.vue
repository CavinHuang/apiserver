	...
	<el-row class="container">
		<el-col :span="24" class="header">
			<el-col :span="10" class="logo" :class="collapsed?'logo-collapse-width':'logo-width'">
				<router-link to="/home/welcome" tag="span">{{collapsed ? '' : sysName}}</router-link>
			</el-col>
			<el-col :span="10">
			...
			<el-col :span="4" class="userinfo">
				<el-dropdown trigger="hover">
					<span class="el-dropdown-link userinfo-inner"><img :src="getUserInfo.userimg"/> {{getUserInfo.name}}</span>
					<el-dropdown-menu slot="dropdown">
						<el-dropdown-item><router-link to="/home/userinfo" tag="span">设置</router-link></el-dropdown-item>

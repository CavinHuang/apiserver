...
use App\Services\ApiServer\Response\Qrcode as qrApi;
class TestController extends \Illuminate\Routing\Controller {

  public function index(){
    $app_scret = 'YYMON6FGURMKJLDLTUCZ8QCHUADLN683JBIIZREZVQIEG9RQZXWHHD8SXXMAUPJN';
...
//  dump($returl);
   ...
   // YYMON6FGURMKJLDLTUCZ8QCHUADLN683JBIIZREZVQIEG9RQZXWHHD8SXXMAUPJNapp_idTY201708090326537823883015formatjsonmethodArticleCollect.sogoWechatArticleDetailnoncemH3TTjPAWPwIJL2Iqkvvo7E2R5dF45hQsign_methodmd5urlhttp://mp.weixin.qq.com/s/VBAjhQY-2-z8UTXJpwMFFQYYMON6FGURMKJLDLTUCZ8QCHUADLN683JBIIZREZVQIEG9RQZXWHHD8SXXMAUPJN

  //YYMON6FGURMKJLDLTUCZ8QCHUADLN683JBIIZREZVQIEG9RQZXWHHD8SXXMAUPJNapp_idTY201708090326537823883015formatjsonmethodArticleCollect.sogoWechatArticleDetailnonceaHwECVQhaizsZ9UqBvTCFYTqmOskDiFssign_methodmd5urlhttp://mp.weixin.qq.com/s/VBAjhQY-2-z8UTXJpwMFFQYYMON6FGURMKJLDLTUCZ8QCHUADLN683JBIIZREZVQIEG9RQZXWHHD8SXXMAUPJN

    //YYMON6FGURMKJLDLTUCZ8QCHUADLN683JBIIZREZVQIEG9RQZXWHHD8SXXMAUPJNapp_idTY201708090326537823883015content003tJCdP4QXEe8logo_size100,100logo_urlhttp://www.wvmp360.com/images/wv1.jpgmethodQrcode.createQrcodenoncemH3TTjPAWPwIJL2Iqkvvo7E2R5dF45hQYYMON6FGURMKJLDLTUCZ8QCHUADLN683JBIIZREZVQIEG9RQZXWHHD8SXXMAUPJN

    //,100logo_urlhttp://www.wvmp360.com/images/wv1.jpgmethodQrcode.createQrcodenoncemH3TTjPAWPwIJL2Iqkvvo7E2R5dF45hQYYMON6FGURMKJLDLTUCZ8QCHUADLN683JBIIZREZVQIEG9RQZXWHHD8SXXMAUPJN
    return view('test');
  }

  public function set(){

    Redis::set('badwords', json_encode(config('badwords'), JSON_UNESCAPED_UNICODE));
  }

  public function create_badwords(){
    $str = '回民吃猪肉
习近平
TMD
毛民进党
...
str;
  ...
  public function qrcode(){
    ...
    list($br, $bg, $bb) = explode(',', $background_color);
    $images = QrCode::encoding('UTF-8')->color($r,$g,$b)->backgroundColor($br,$bg, $bb)->format('png')->size($size)->margin($margin)->merge('http://www.xzg168.com/UploadFiles/2016-1/201612216302811.jpg',$logo_size, true)->generate('http://jinye.weix360.cn/home/Tables/gettables/uid/719.html?store_id=34');
    return response($images)->header('Content-Type', 'image/png');
  }

  public function wallpaper(){
    $logo = 'http://api.tywebs.cn/logo.png';
    ...
    $img = Image::make(ROOT.'/upload/wallpaper/1.jpg');
    $img->insert(file_get_contents($logo),'top-left', 217, 1006);
    // dd($logo_resource_result);
    //$img->insert(Image::make(());
    $img->insert(Image::make((new qrApi('createQrcode', ['content'=>'http://image.intervention.io/api/make','size'=>15, 'rpc'=>true]))->createQrcode()), 'top-left',324, 1204);
    // dump($result);
    return $img->response('jpg');
  }

  public function collect(){
    /*$url = "http://weixin.sogou.com/wapindex/wap/0612/wap_2/12.html";
    ...
    return response()->json($hj->data);*/

    //https://m.toutiao.com/list/?tag=__all__&ac=wap&count=20&format=json_raw&as=A1F5B9B9E52005C&cp=5995508055ACEE1&min_behot_time=0

    //https://m.toutiao.com/list/?tag=__all__&ac=wap&count=20&format=json_raw&as=A195495965500C7&cp=5995C0D06CB7CE1&max_behot_time=1502937018

    // http://www.toutiao.com/api/pc/feed/?max_behot_time=1502939922&category=__all__&utm_source=toutiao&widen=1&tadrequire=false&as=A1D5991905B0B73&cp=5995903B97D31E1

    // http://www.toutiao.com/api/pc/feed/?min_behot_time=0&category=__all__&utm_source=toutiao&widen=1&tadrequire=true&as=A17589E9F500B18&cp=5995C03BF1287E1



    /*$url = "http://www.toutiao.com/api/pc/feed/?category=__all__&utm_source=toutiao&widen=1&tadrequire=true&as=A17589E9F500B18&cp=5995C03BF1287E1&min_behot_time=1502934480&max_behot_time=";
    ...
    $url = 'http://www.toutiao.com/a6455059370475651341/';
    ...
    $hj = QueryList::Query($url, array(
      ...
      'author'=>array('.article-box>.article-sub','html', [], function ($content) {
        $doc = \phpQuery::newDocumentHTML($content);
        $span = pq($doc)->find('span');
        return pq($span[0])->text();
      }),
      'time'=>array('.article-box>.article-sub','html', [], function ($content) {
        $doc = \phpQuery::newDocumentHTML($content);
        $span = pq($doc)->find('span');
        return pq($span[1])->text();
      }),
      'content' => ['.article-content', 'html'],
      'tag' => ['.tag-list','html', [], function ($tag) {
        $doc = \phpQuery::newDocumentHTML($tag);
        $lis = pq($doc)->find('li');
        $tag_arr = [];
        foreach ($lis as $li){
          $tag_arr[] = pq($li)->find('a')->text();
        }
        return $tag_arr;
      }],
      'comment' => ['#comment>.c-header>em', 'text'],
    ));
    //输出结果：二维关联数组

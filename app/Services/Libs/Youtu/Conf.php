...
class Conf
{
    ...
    public static $APPID = '10094298';
    public static $SECRET_ID = 'AKIDUtYN3dpQYXK2dATrwqcFiATeYLxPHCLJ';
    public static $SECRET_KEY = 'Xr55vY1YlqiQehgNwLYZ9i5KNEtNflux';
    public static $END_POINT = '';


    // 开发者 QQ
    public static $USER_ID = '943866180';
